package com.scwl.hzzxgd.encryptionAndDecryption;
...
//		String sToken = "OY0Q7Ny7ktHl54";
//		String sCorpID = "ww53c8160388d016ee";
//		String sEncodingAESKey = "2KiraEkiexJv0k8h5Jr5uwonGxmEmqmMu9HHkTNSBAj";
...
//		System.out.println(wxcpt);
		...
		*企业开启回调模式时，企业微信会向验证url发送一个get请求
		假设点击验证时，企业收到类似请求：
		* GET /cgi-bin/wxpush?msg_signature=5c45ff5e21c57e6ad56bac8758b79b1d9ac89fd3&timestamp=1409659589&nonce=263014780&
...
//
//		try {
//			String sMsg = wxcpt.DecryptMsgJson(sReqMsgSig, sReqTimeStamp, sReqNonce, sReqData);
//			System.err.println("after decrypt msg: " + sMsg);
...
//		}
		...
		*/
		...
		try {
			String sMsg = wxcpt.DecryptMsgXML(sReqMsgSig, sReqTimeStamp, sReqNonce, sReqData);
