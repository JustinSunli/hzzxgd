...
public class WXBizJsonMsgCrypt {
	 ...
	 */
	public WXBizJsonMsgCrypt(String token, String encodingAesKey) throws AesException {
...
//        }
     ...
     * @throws AesException 执行失败，请查看该异常的错误码和具体的错误信息
     */
	public String DecryptMsgXML(String msgSignature, String timeStamp, String nonce, String postData)
			throws AesException {
